...
namespace BRIDGES.Geometry.Euclidean3D
{
    ...
    public class NurbsSurface : Kernel.BSplineSurface<Projective3D.Point>
    {
        ...
        /// </summary>
        /// <param name="degreeU"> Degree of the interpolating polynomials in the <see cref="Uni_Spe.BSpline"/> basis in u-direction. </param>
        /// <param name="degreeV"> Degree of the interpolating polynomials in the <see cref="Uni_Spe.BSpline"/> basis in v-direction. </param>
