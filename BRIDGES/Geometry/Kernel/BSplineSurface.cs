...
namespace BRIDGES.Geometry.Kernel
{
        ...
        IMultiplyOperators<TPoint, double, TPoint>, IDivisionOperators<TPoint, double, TPoint>
    {
        ...
        /// <summary>
        /// Gets the degree of the interpolating polynomials in the <see cref="Arithmetic.Polynomials.Univariate.Specials.BSpline"/> basis in u-direction.
        /// </summary>
        public int DegreeU { get; protected set; }

        /// <summary>
        /// Gets the degree of the interpolating polynomials in the <see cref="Arithmetic.Polynomials.Univariate.Specials.BSpline"/> basis in v-direction.
        /// </summary>
        public int DegreeV { get; protected set; }


        /// <summary>
        /// Number of knots of the interpolating <see cref="Arithmetic.Polynomials.Univariate.Specials.BSpline"/> polynomial basis in u-direction.
        /// </summary>
        public int KnotCountU { get { return _knotVectorU.Count; } }

        /// <summary>
        /// Number of knots of the interpolating <see cref="Arithmetic.Polynomials.Univariate.Specials.BSpline"/> polynomial basis in v-direction.
        /// </summary>
        ...
        /// Initialises a new instance of <see cref="BSplineSurface{TPoint}"/> class.
        /// </summary>
        /// <param name="degreeU"> Degree of the interpolating polynomials in the <see cref="Arithmetic.Polynomials.Univariate.Specials.BSpline"/> basis in u-direction. </param>
        /// <param name="degreeV"> Degree of the interpolating polynomials in the <see cref="Arithmetic.Polynomials.Univariate.Specials.BSpline"/> basis in v-direction. </param>
        ...
        {
            int i_KnotSpanU = Uni_Spe.BSpline.FindKnotSpanIndex(parameter.Item1, DegreeU, _knotVectorU);
            int i_KnotSpanV = Uni_Spe.BSpline.FindKnotSpanIndex(parameter.Item2, DegreeV, _knotVectorV);

            double[] bSplinesU = Uni_Spe.BSpline.EvaluateBasisAt(parameter.Item1, i_KnotSpanU, DegreeU, _knotVectorU);
            double[] bSplinesV = Uni_Spe.BSpline.EvaluateBasisAt(parameter.Item2, i_KnotSpanV, DegreeV, _knotVectorV);
            ...
            for (int i_U = 0; i_U < bSplinesU.Length; i_U++)
            {
                ...
                {
                    TPoint temp = _controlPoints[i_KnotSpanU - DegreeU + i_U, i_KnotSpanV - DegreeV + i_V] * (bSplinesU[i_U] * bSplinesU[i_V]);
                    result = result + temp;
                }
            }
        ...
        /// <param name="degrees"> Degrees of the interpolating polynomials in the <see cref="Arithmetic.Polynomials.Univariate.Specials.BSpline"/> basis in u and v directions. </param>
        /// <param name="knotCounts"> Number of knots of the interpolating <see cref="Arithmetic.Polynomials.Univariate.Specials.BSpline"/> polynomial basis in u and v directions. </param>
