...
namespace BRIDGES.DataStructures.PolyhedralMeshes.HalfedgeMesh
{
    ...
    public class Halfedge<TPosition> : IEquatable<Halfedge<TPosition>>
        where TPosition : IEquatable<TPosition>
    {
        ...
        /// </summary>
        public Vertex<TPosition> StartVertex { get; private protected set; }

        /// <summary>
        /// Gets the end vertex of the current edge.
        /// </summary>
        public Vertex<TPosition> EndVertex { get; private protected set; }


        /// <summary>
        /// Gets the previous halfedge of the current halfedge.
        /// </summary>
        public Halfedge<TPosition> PrevHalfedge { get; internal set; }

        /// <summary>
        /// Gets the next halfedge of the current halfedge.
        /// </summary>
        public Halfedge<TPosition> NextHalfedge { get; internal set; }

        /// <summary>
        /// Gets the pair halfedge of the current halfedge.
        /// </summary>
        public Halfedge<TPosition> PairHalfedge { get; internal set; }


        /// <summary>
        /// Gets the adjacent face of the current halfedge.
        /// </summary>
        public Face<TPosition> AdjacentFace { get; internal set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Halfedge{TPosition}"/> class.
        /// </summary>
        ...
        internal Halfedge(int index, Vertex<TPosition> startVertex, Vertex<TPosition> endVertex)
        {
        ...
        /// <summary>
        /// Initialises a new instance of the <see cref="Halfedge{TPosition}"/> class.
        /// </summary>
        /// <param name="index"> Index of the added halfedge in the mesh. </param>
        /// <param name="startVertex"> Start vertex of the halfedge. </param>
        /// <param name="endVertex"> End vertex of the halfedge. </param>
        /// <param name="adjacentFace"> Adjacent face of the halfedge. </param>
        internal Halfedge(int index, Vertex<TPosition> startVertex, Vertex<TPosition> endVertex, Face<TPosition> adjacentFace)
        {
            // Instanciate properties
            PrevHalfedge = null;
            NextHalfedge = null;
        ...
        public Edge<TPosition> GetEdge()
        {
            ...
            if (parity == 0) { _edge = new Edge<TPosition>(this); }
            // If the current halfedge index is odd.
            else { _edge = new Edge<TPosition>(PairHalfedge); }
        ...
        {
            return obj is Halfedge<TPosition> halfedge && Equals(halfedge);
        }
