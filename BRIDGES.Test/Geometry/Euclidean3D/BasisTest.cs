...
namespace BRIDGES.Test.Geometry.Euclidean3D
{
    ...
    public class BasisTest
    {
        ...
        {
            // Arrange
            Basis expected = new Basis(new Vector(1.0, 2.0, -0.5), new Vector(-1.5, 2.5, 1.0), new Vector(-0.6, -0.4, 2.0));
            ...
            // Assert
            Assert.IsTrue(basis.Equals(expected));
        ...
        public void Constructor_Basis()
        {
            ...
            // Act
            Basis basis = new Basis(expected);
